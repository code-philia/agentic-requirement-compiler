...
def get_common_session_guidance() -> str:
    return _section(
        ...
        [
            ...
            "When diagnosing request paths or route mismatches, inspect the caller, any shared client/base configuration, and the receiving route together before changing literals.",
        ...
        [
            ...
            _section(
                ...
                [
                    ...
                    "If the current node owns only UI or UI-plus-request wiring, keep repairs inside that scope unless the current failing batch proves a reused backend or persistence boundary is the blocker.",
